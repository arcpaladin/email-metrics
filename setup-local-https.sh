...
echo "1. Go to Azure Portal > App Registrations > Your Application"
echo "2. Navigate to 'Authentication' section"
echo "3. Add these redirect URIs under 'Single-page application (SPA)':"
echo "   - https://localhost:5001/"
echo "   - https://localhost:5001"
echo "   - http://localhost:5000"
echo "4. Ensure 'Access tokens' and 'ID tokens' are checked"
echo "5. Update your .env.local file with your Azure credentials:"
